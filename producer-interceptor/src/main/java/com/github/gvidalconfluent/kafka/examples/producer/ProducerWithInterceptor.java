...
public class ProducerWithInterceptor {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while (latch.getCount() > 0) {
            producer.send(
                    new ProducerRecord<>("my-topic", "interceptor-key", "interceptor-value"),
                    (metadata, exception) -> {
                if (exception != null) {
    ...
    private static Properties newProducerConfig() {
        ...
        //props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "pkc-2396y.us-east-1.aws.confluent.cloud:9092");
